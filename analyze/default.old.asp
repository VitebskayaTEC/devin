...
<BODY>
	<% 
		...
		Dim base(1000,8), computers(1000,1), sklad(1000,4), printers(1000,8), tempPrinter(4), noPrinters(1000,5), parsed(10), cartridges(1000,8), excel(1000,5), template, baseN, computersN, printersN, noPrintersN, cartridgesN, excelN, skladN, i, j, prevPrinter, prevPrinterCN, newCartridge, searchCartridge, noPrinter
